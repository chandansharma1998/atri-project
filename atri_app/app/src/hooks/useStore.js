...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox139": {
      "custom": {
        "text": "ugue quam diam vitae velit bibendum elementum eget non"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox140": {
      "custom": {
        "text": "vivamus volutpat odio cras vestibulum purus aliquam."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image3": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616d9a0b63b4ee3fe71f5072_logo-doorash-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image4": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616d9a0b326163db6497f05b_logo-rappi-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image6": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616d9a0b5b82ce962fe1736b_logo-grubhub-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image7": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616d9a0bded3b95d9731ecc4_logo-postmates-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image8": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dcfaa447d37fed264e4ff_menu-breakfasts-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image9": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dcfbb9e09be616e71d818_menu-main-dishes-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image10": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dcfb5dd3ca61a6dd0ae1c_menu-drinks-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image15": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c3a1718503bfe60f49_location-icon-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c36165d583fe91702b_phone-icon-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image18": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c3400864a9087440a4_email-icon-restaurante-x-template.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox53": {
      "custom": {
        "text": "dolor consectetur adipiscing elit"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox78": {
      "custom": {
        "text": "bibendum elementum. Order online"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image38": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/left-arrow-svgrepo-com.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image33": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/star-svgrepo-com.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image39": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/right-arrow-svgrepo-com.png"
      },
      "callbacks": {
        "onClick": [
          {
