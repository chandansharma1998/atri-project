...
export function usesection1Cb() {
	const onClick = useCallback(callbackFactory("section1", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function usesection1leftCb() {
	const onClick = useCallback(callbackFactory("section1left", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
