...
class Atri:
	def __init__(self, state: Any):
		...
		self.section1left = state["section1left"]
	...
	@property
	def section1left(self):
		self._getter_access_tracker["section1left"] = {}
		return self._section1left
	@section1left.setter
	def section1left(self, new_state):
		self._setter_access_tracker["section1left"] = {}
		global default_state
		self._section1left = Flex(new_state, default_state["section1left"])
	...
	def _to_json_fields(self):
		return {
			...
			"section1left": self._section1left,
			"Flex7": self._Flex7,
			"Div4": self._Div4,
			"Flex10": self._Flex10,
			"Flex11": self._Flex11,
